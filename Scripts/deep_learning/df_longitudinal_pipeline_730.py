...
NA_removal_threshold = 0  ##atleast this many columns should have a non null value
test_df_control_ratio = 2

BASE_PATH='/home/boses08/hype-prediction-longitudinal/ml'

# DATA_FILE_PATH="../../data/raw/"
DATA_FILE_PATH = "/home/boses08/hype-prediction-longitudinal/ml/data/raw_with_mrn/730/"
DATA_UNSUPERVISED_PATH = "/home/boses08/hype-prediction-longitudinal/ml/v2/prepare_multi_modal_data/data/diag_drug_proc_730.parquet"
MRN_PATH = "/home/boses08/hype-prediction-longitudinal/ml/v2/src/Suparno_Experiment/data/selected_MRNs/ML_dataset_730.pkl"
...
def impute_unsupervised_data(train_df, test_df, train_labels):
...
if __name__ == "__main__":
    ...
    print(unsupervised_data[['medical_record_number', 'HT']].tail(10))
    ...
    train_unsupervised_data, test_unsupervised_data = impute_unsupervised_data(train_unsupervised_data,test_unsupervised_data, train_labels)
