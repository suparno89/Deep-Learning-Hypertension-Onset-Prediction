...
def get_shap_importanceplot(train_df, test_df):
    ...
    with open('xgb_shap_importance_730.csv', 'w') as f:
        for key in sorted_agg_dict.keys():
            f.write("%s, %s\n" % (key, sorted_agg_dict[key]))
    print('Saved csv succefullly')
...
if __name__ == "__main__":
    ...
    df =  pd.read_pickle(os.path.join('/home/dattas03/hype_cohorts_ml/', output_filename))
